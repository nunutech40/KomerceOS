...
import '../features/superapp/features/authentication/bloc/login_bloc.dart' as superapp_auth;
...
Future<void> initDependencies() async {
  ...
  locator.registerFactory(() => LoginBloc(checkEmailLoginUseCase: locator(), doLoginUseCase: locator(), recaptchaUseCase: locator()));
  ...
  locator.registerFactory(
    () => TopUpBloc(
      topUpUseCase: locator(),
      topUpQrissUseCase: locator(),
      topUpDetailUseCase: locator(),
      topUpCancelUseCase: locator(),
  ...
  locator.registerFactory(() => ProfilePageBloc(
      doLogoutUseCase: locator(),
      getProfileUseCase: locator(),
      checkPinUseCase: locator()));
  ...
  locator.registerFactory(() => SaldoWithdrawalBloc(
      getBankListWithdrawalUseCase: locator(),
      checkPinUseCase: locator(),
      idealBalanceUseCase: locator()));
