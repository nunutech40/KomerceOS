              ...
              _widgetbook.WidgetbookFolder(
                ...
                children: [
                  _widgetbook.WidgetbookComponent(
                    ...
                    useCases: [
                      _widgetbook.WidgetbookUseCase(
                        ...
                        builder:
                            _komtim_partner_common_global_design_system_widgetbook_usecase_ds_bottom_sheet_usecase
                                .buildInteractiveDsBottomSheet,
                      )
                    ],
                  ),
                  _widgetbook.WidgetbookComponent(
                  ...
                  _widgetbook.WidgetbookComponent(
                    ...
                    useCases: [
                      _widgetbook.WidgetbookUseCase(
                        name: 'Interactive Email Input',
                        builder:
                            _komtim_partner_common_global_design_system_widgetbook_usecase_ds_email_input_usecase
                                .buildInteractiveDsEmailInput,
                      )
                    ],
                  ),
                  _widgetbook.WidgetbookComponent(
                    ...
                    useCases: [
                      _widgetbook.WidgetbookUseCase(
                        name: 'Interactive OTP Field',
                        builder:
                            _komtim_partner_common_global_design_system_widgetbook_usecase_ds_otp_field_usecase
                                .buildInteractiveDsOtpField,
                      )
                    ],
                  ),
                  _widgetbook.WidgetbookComponent(
                    name: 'DsPasswordField',
                    useCases: [
                      _widgetbook.WidgetbookUseCase(
                        name: 'Interactive Password Field',
                        builder:
